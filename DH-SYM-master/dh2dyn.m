...
%	DH2DYN
%
%	Generates the dynamics of an N-link kinematic chain in Brunovsky form, i.e.
%
%		D(q)*ddq + C(q,dq)*dq + V(q) = tau
%
%	Kinematic chain is modeled with inertia-less links ("floating" point masses).
%
%	Outputs:
%		
%		D 		N x N mass matrix
...
% 				kinematic chain. The table should be percribed as a symbolic array
% 				like so:
%
